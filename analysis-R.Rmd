...
— [Evely Hall and Simon ’Yoda’ Blomberg, R-help April 2005](https://www.brodrigues.co/blog/2022-06-02-arcane/)
...
1. Request an API token for both REDCap projects (School Readiness Study, School Readiness Study Screening):
https://redcap.icts.uiowa.edu/redcap/api/help/?content=tokens
1. When your API token has been approved for both projects, open the `Encrypt REDCap Token.R` script:
...
1. Uninstall `R`
1. Install the new `R` version into a directory that contains no spaces (see Step 2 [above](#setup))
