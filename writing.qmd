...
1. Know the difference between a hyphen (-), minus sign (−), en dash (–), and em dash (—), and use them correctly (see [here](https://jakubmarian.com/hyphen-minus-en-dash-and-em-dash-difference-and-usage-in-english/); archived at <https://perma.cc/3XQ6-DBNW>).
    - [Unicode values](https://www.punctuationmatters.com/the-difference-between-a-dash-and-a-minus-sign/) (archived at <https://perma.cc/Q9GM-SSCL>) for each character:
      ...
      - en dash (–): 2013
      - em dash (—): 2014
    - If you want an easy way to type these or other frequent characters/words/phrases/sentences, see [espanso](https://espanso.org).
1. When submitting a manuscript to a journal, submit any supplemental appendices as a PDF (not as a Word file).
1. When submitting a manuscript to a journal, follow the lab's [open science](openScience.qmd) guidelines.
    - For instance, see the section on "[Manuscript Submission to a Journal](openScience.qmd#sec-journal)."
    - When the manuscript is accepted for publication, follow the guidelines in the section on "[When the Manuscript is Accepted for Publication](openScience.qmd#sec-accepted)"
1. You are expected to follow the [Henry Kissinger criterion](expectations-gradStudent.qmd#sec-communication)—before sending a manuscript to Dr. Petersen, make sure it is your <u>best possible work</u>.
