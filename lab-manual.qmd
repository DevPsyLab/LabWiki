...
# Mission Statement {#sec-missionStatement}

## External Mission Statement {#sec-missionStatement-external}
...
## Internal Mission Statement {#sec-missionStatement-internal}
...
## Diversity Statement {#sec-diversityStatement}
...
Even when using Discord to communicate with team members about visits or lab-related tasks, team members should always use TCIDs and waves, which are de-identified, to refer to specific participants/videos.

## Remote Access {#sec-remote}
...
# How to Register Lab for Credit {#sec-courseRegistration}

## Regular Credit {#sec-regularCredit}

Students who wish to receive credit for time spent in the lab may register for credit. 

"`PSY:3994:01IND – Research Practicum in Psychology`" 
...
- *Recommended for students' first two semesters in lab (except summer semester).* 

"`PSY:3995:01IND – Advanced Research Practicum in Psychology`"
...
- *Recommended for students after completing their first two semesters in lab.*

"`PSY:3999:01IND – Independent Research in Neuroscience`"

- Independent scientific research related to the field of neuroscience.

"`BIOL:3999:01IND – Independent Research in Neuroscience`"

- Independent scientific research related to the field of neuroscience, for neuroscience/biology majors.

"`HHP:3994:0IND – Undergraduate Research`"

- Laboratory research in health, human physiology, or related science fields.

"[`HONR:3994:01IND – Honors Research Practicum`](#sec-honorsCredit)"

- Individual research performed in conjunction with a faculty member's research.

"[`PSY:4990:01IND – Honors Thesis Research`](#sec-honorsCredit)"

- Supervised original project; leads to written thesis, oral defense.

"`URES:3991 – Undergraduate Research and Creative Projects`"

- A 0-hour and has no tuition or fees associated.
It is recommended to enroll in `URES:3991` <u>during the academic year</u> when you cannot take credit-bearing courses (e.g., if you are getting paid, if you do not have the ability to maintain a regular schedule, etc.).

"`URES:3992 – Undergraduate Research and Creative Projects`"

- A 0-hour and has no tuition or fees associated.
It is recommended to enroll in `URES:3992` <u>during the summer</u> when you cannot take credit-bearing courses (e.g., if you are getting paid, if you do not have the ability to maintain a regular schedule, etc.).
...
Generally, students enroll in "`PSY:3994`" or, if they want [Honors credit](#sec-honorsCredit), "[`HONR:3994`](#sec-honorsCredit)".
After two semesters in the lab, students are able to register for "`PSY:3995`".

Keep in mind that some courses differ in the way that they are graded.

- Students receive a **letter grade** (see the section on [Honors Credit](#sec-honorsCredit)) for `PSY:4990`, `HONR:3994`, `PSY:3995`, and `PSY:3999`. 
...
Important note on registering for Pass/Fail credit:

- A maximum of 15 P ("Pass") credits is accepted toward your bachelor's degree.
- We recommend consulting with your advisor when deciding to register for Pass/Fail credit or a letter grade, and regarding which course designation to register for.

![PSY:3994 Step 1](images/psy3994_1.png)
![PSY:3994 Step 2](images/psy3994_2.png)

## Honors Credit {#sec-honorsCredit}
...
For information on conducting an Honors thesis/project, see [here](honors.qmd).
...
We have three specialized tracks or roles that RAs can train in after completing basic lab training: [Behavioral Testing Specialist](#sec-behavioralTestingSpecialist), [Electroencephalography (EEG)
 Specialist](#sec-eegSpecialist), and [Data Specialist](#sec-dataSpecialist).
...
## Specialized Roles {#sec-specializedRoles}

### Behavioral Testing Specialist {#sec-behavioralTestingSpecialist}
...
### EEG Specialist {#sec-eegSpecialist}
...
### Data Specialist {#sec-dataSpecialist}
...
# RA Advancement in Lab {#sec-advancement}
...
In addition to opportunities for advancement in lab, there may also be opportunities to conduct independent research projects, to conduct an [Honors project/thesis](honors.qmd), or to contribute to papers, grants, or conference poster presentations.
...
There may be an opportunity for some experiences to count for lab hours if:
   ...
   1. The project is not part of an [Honors project/thesis](honors.qmd), or another independent research experience
...
# Lab Buddy System {#sec-labBuddySystem}
...
## Scheduling System Overview {#sec-schedulingOverview}
...
If an RA has been scheduled for a visit during their availability (including available time on weekdays, available evenings, and chosen weekend days), has been notified of this visit, and cannot run the visit due to an unexpected conflict, the RA is responsible for posting on the `#scheduling` channel on Discord to ask for a cover.
...
For information regarding weekend visits, please refer to the section regarding the [Weekend On-Call Schedule](#sec-schedulingWeekend).

For general information regarding the scheduling expectations for undergraduate RAs of the Developmental Psychopathology Lab, please refer to the section on [Scheduling Expectations](expectations-undergradRA.qmd#sec-schedulingExpectations).

## Weekend On-Call Schedule {#sec-schedulingWeekend}
...
If a weekend visit is scheduled and you are on-call that day, the Lab Coordinator will tag you in a Discord with the details of the visit.
...
Ultimately everyone is expected to be on-call for at least 8 weekend days per semester (apart from Advanced Specialists; see the section on [RA Advancement](#sec-advancement)).
...
## Shared Calendars {#sec-sharedCalendar}
...
# The Basics of Lab {#sec-basicsLab}

## Lab Meetings {#sec-lab-meetings}
...
### Article Discussion {#sec-articleDiscussion}
...
By Monday of the week the article will be discussed, the RA picking the article should post 1) the article PDF (the actual PDF file of the article, not the URL link to the PDF) and 2) the full APA-style reference in the `#lab-meetings` channel on Discord.
For more information on how to find and access articles, see [here](honors.qmd#sec-articles).
...
### Lab Meeting Scribe {#sec-labScribe}
...
The scribe also sends a brief summary of the important information from the meeting to the entire team via the `#lab-meetings` channel in Discord after the lab meeting has ended.
The scribe also adds the summary to the "Lab Meeting Agendas – Team" in the [lab's OneDrive](#sec-onedrive).

### Attendance and Absence Policies {#sec-lab-meeting-attendance}
...
They are also responsible for emailing several detailed questions or comments on the article to the presenting student AND to the lab email ([devpsy-lab@uiowa.edu](mailto:devpsy-lab@uiowa.edu)) by the day before the meeting to help contribute to the discussion.
...
## Lab Communication {#sec-labCommunication}

Forms of lab communication are described below.
**Please use Discord for as much communication as possible!**
Keeping lab-related communication on Discord helps our team work most effectively and efficiently, and it saves time for the Lab Coordinator, Dr. Petersen, and your team members because it allows other RAs to answer questions and allows people to jump in to provide corrective feedback, as necessary.

1. Non-private lab-related communication (almost all communication)
    - Use Discord
        - See the [Discord Checklist](#sec-discord)
        ...
        - Discord communication can be informal!
...
1. Private lab-related communication 
    - Send an email to the lab email ([devpsy-lab@uiowa.edu](mailto:devpsy-lab@uiowa.edu)), call the Lab Coordinator (319-353-1977), or discuss with the Lab Coordinator in person
...
1. Download the "Discord" App to your mobile phone (it is free!)
1. You can also access Discord on any internet browser (<https://discord.com>): <https://discord.com/channels/@me>
1. If you do not already have a Discord account, create a Discord account with a password you will remember.
You can use either your university email address or a non-university email address.
However, regardless of which email you use, make sure that your notifications are set up so that you will receive notifications for lab-related messages.
1. Open the Discord server for the Developmental Psychopathology Lab (Dr. Petersen or the Lab Coordinator should have added you to the workspace prior to your start in lab as part of your onboarding).
...
1. Pinned messages: Important pinned messages are available in each channel by clicking the thumb tack icon.
For example, the semester schedule and link to OpenTimeClock are pinned in the main `#announcements` channel for easy team access.
1. Direct Messages: Do not use direct messages or private threads in Discord.
...
If you need to communicate privately with the Lab Coordinator or Dr. Petersen, please use email (see the section on [Lab Communication](#sec-labCommunication) for more information)

Discord channels are meant to organize conversations within broad overarching topics, but within each channel we want diverse conversation to span the gamut of each topic.
For example, the `#coding-scoring` channel should include conversations ranging from discrepancies between two coders on a given task, to technical discussions about Datavyu, to general questions to the Lab Coordinator and Dr. Petersen about the constructs measured in a given task, to all of the procedures, systems, and programs in between.
...
Notion is a shared project management and note-taking workspace. 
The primary purpose of our Notion board is to have a shared space to organize ongoing coding, scoring, and entry tasks. 

<u>Expected Use:</u>

- Coding and scoring teams should use the `Coding`, `Entry`, or `Scoring` teamspaces to keep track of videos that are actively being coded
- RAs should keep track of comments and questions to be referenced during coding team meetings

<u>Optional Use:</u>

- RAs may use the `Personal Tasks` teamspace to keep track of their own to-do list related to lab work
- RAs may choose to keep track of their training progress in the `Training Progress` teamspace

### Supervision of Coding & Scoring Teams {#sec-supervisingCodingScoring}

The lab coordinator, lab staff, and graduate students will serve as supervisors for one or more coding/scoring tasks in the lab.
The individual supervising the task will serve as the primary point of contact for the RA team assigned to the task.

<u>Supervisor responsibilities:</u>

- Maintain frequent communication with the RA team
- Lead at least one formal check-in with the RA team at the beginning of the semester
    - Check-in meetings should include:
        - Review of task goals and progress
        - Discussion of training for new coders/scorers
        - Opportunity to address questions or concerns
    - Additional check-in meetings may be necessary depending on the needs of the task
    - Some tasks will require a meeting with Dr. Petersen in addition to routine check-in meetings
- Establish reasonable expectations for task progress (e.g. number of videos coded/scored per week, end-of-semester goals, etc.)
- Monitor task progress and provide feedback or guidance as needed
- Assist with troubleshooting technical difficulties and conceptual challenges
- Communicate any changes to task expectations, procedures, or priorities to the RA team

<u>RA team responsibilities:</u>

- Maintain frequent communication with the task supervisor
- Come to task check-in meetings prepared with questions, examples, and progress updates
- Work toward established task progress expectations and communicate with the supervisor if there are concerns about meeting those expectations
- Attempt to troubleshoot technical or conceptual challenges within the team first before reaching out to the supervisor
- Communicate questions or concerns to the supervisor when challenges cannot be resolved within the team 

### Social Media {#sec-socialMedia}

The purpose of our social media pages is to inform the outside world of our research.
One to two members of the [Data Specialist team](#sec-dataSpecialist) are responsible for creating posts.
...
This folder includes:
    ...
    Every week, the [lab scribe](#sec-labScribe) will add detailed meeting notes to this document
...
**&#35;2 Rule: If you accidentally delete or move documents, folders, etc., contact the Lab Coordinator, graduate students, or Dr. Petersen <u>IMMEDIATELY</u>. 
We are able to recover deleted items for up to 4 months.** 
...
You may move it to an "00-Old" folder (see [Folder Designations](#sec-folderDesignations) below), or, if you are unsure where it should be saved, consult your fellow lab members or the Lab Coordinator.
...
### Folder Designations {#sec-folderDesignations}
...
## Bi-Weekly Lab Reports {#sec-labReport}
...
- they provide an avenue for you to make suggestions that can help improve the lab and study.
(Of course, you can make suggestions to the team in other ways, too.)
...
Do not put personnel grievances in lab reports.
- Lab reports are expected whenever the RA has worked in the lab for at least 9 hours during the two-week reporting period.
If an RA is on vacation or otherwise absent when a report is due but has worked at least 9 hours during the reporting period, they are still expected to complete a report covering the week(s) they worked and to submit it by the regular due date.
If you know a lab report will be due while you are away, you should submit it before you leave so that it is received by the due date.
If an RA does not work at least 9 hours during a reporting period, no lab report is required for that reporting period.
If no lab report is required because you worked fewer than 9 hours during the reporting period, please save a document in your lab reports folder—by the regular due date—that indicates that you did not work (or will not have worked) at least 9 hours in the lab during that reporting period.
- **Lab report due dates can be found on the lab schedule that is shared via OneDrive under the "Lab Article" tab!**

## Tips and Tricks for Interacting with Children in Lab {#sec-interactingWithChildren}
...
### How to Guide Children Through Difficult Tasks {#sec-guideChildrenDifficultTasks}
...
# Professional Development {#sec-professionalDevelopment}
...
Please read and follow the lab's [AI policy](ai-policy.qmd).

# Lab Organizational Chart {#sec-organizationalChart}
