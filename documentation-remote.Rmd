...
# VPN Access to the Lab Drive

- To access the lab drive, you must connect to the university's VPN using Cisco AnyConnect.
Visit this website to learn how to set up VPN access to the lab drive: https://its.uiowa.edu/support/article/1876
...
# Map the Lab Drive Onto a Mac Computer

- In the upper task bar, click "Go", then select "Connect to Server" from the drop-down menu
- Type `smb://iowa.uiowa.edu/shared/ResearchData/rdss_itpetersen/Lab/` in the search bar
...
You can remote in to a lab computer using a program called "Remote Desktop." Visit this website to learn how to set up Remote Desktop access on your computer: https://its.uiowa.edu/remotedesktop
