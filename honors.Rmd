...
For instructions how to do each, see below, or see the [RA Remote Participation page](documentation-remote.html).

## VPN Access to the Lab Drive {#vpn}

For information on how to VPN in to the lab drive, see [here](documentation-remote.html#vpn).

## Remote Access to a Lab Computer

For information on how to "remote in" to a lab computer, see [here](documentation-remote.html#remoteAccess).
