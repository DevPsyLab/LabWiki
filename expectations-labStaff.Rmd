...
- If RA's are not available, E LV1 visits
- Schedule families who have signed up via Sign-Up Genius
    - Send reminders the night before the visit
- Check in once per week with pending scheduling contacts including: 
...
- Send survey reminders once per week to:
    - Primary caregivers who did not complete surveys during their visits
    - Parenting partners
    - Secondary caregivers
- Develop and refine new recruitment methods including: 
    - Submitting monthly Peach Jar flyer
    - Develop relationships with community organizations
    - Flyering
- Develop coding tasks 
- Schedule Meetings with relevant team members including: 
    - coding meetings
    - trainings
    - other meetings
- Miscellaneous office tasks
- Keep lab website up to date
