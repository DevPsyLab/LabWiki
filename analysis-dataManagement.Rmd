...
```{r, class.source = "fold-show"}
mergedData <- merge(mydata, mydata2, by = "ID", all = TRUE)
...
```{r, class.source = "fold-show"}
merge(mydata, mydata2, by = "ID", all.x = TRUE)
```
...
```{r, class.source = "fold-show"}
merge(mydata, mydata2, by = "ID", all.y = TRUE)
```
...
```{r, class.source = "fold-show"}
merge(mydata, mydata2, by = "ID", all.x = FALSE, all.y = FALSE)
```
...
```{r, class.source = "fold-show"}
anti_join(mydata, mydata2, by = "ID")
```
