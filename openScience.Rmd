...
Before submitting a manuscript to a journal, make sure to post the relevant materials on the [OSF](#osf), as described here, and post the preprint, as described [here](#preprint).
