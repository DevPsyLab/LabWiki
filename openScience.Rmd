...
1. Submit the finalized manuscript (and any tables, figures, and the supplement) to the NIHMS system: https://www.nihms.nih.gov/submission/create/
...
1. Make sure the finalized manuscript (and any tables, figures, and the supplement) is uploaded as an updated version of the [preprint](#preprint) on [PsyArXiv](https://psyarxiv.com).
