...
I have read and understand the above expectations, in addition to the section on [expectations for everyone in the lab](expectations-everyone.html) and the expectations and systems outlined in the "[Scheduling](manual.html#scheduling)" (including "[Scheduling Expectations](manual.html#schedulingExpectations)", "[Scheduling System Overview](manual.html#schedulingOverview)", and "[Weekend On-Call Schedule](manual.html#schedulingWeekend)") sections of the [Developmental Psychopathology Lab Manual](manual.html).
