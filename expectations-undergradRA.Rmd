...
**Semester:**
   ...
   - RAs are expected to provide ~ 8 weekend days in the semester that they are available to run visits
      - This means that RAs signed up for a specific day will be "on-call" for any visits that are scheduled for that day
         - *RAs must be notified of a weekend visit within 24 hours.*


<u>RAs are expected to commit to **at least** 2 semesters of working in lab.</u> We want to ensure that RAs get the most value out of their experience with our lab

RAs interested in specializing must commit to **at least** 3 semesters in order to account for the extensive training process
