...
# Scheduling Expectations {#sec-schedulingExpectations}
...
## Your responsibilities as an RA {#sec-yourSchedulingResponsibilities}
...
# RA Duties: What Does Work as a Research Assistant Entail? {#sec-ra}
...
Any changes to an RA's weekly lab schedule need to be arranged with the Lab Coordinator, in advance, and in person, by phone call (319-353-1977), or via email to the lab email ([devpsy-lab@uiowa.edu](mailto:devpsy-lab@uiowa.edu)).
We expect RAs to let the Lab Coordinator and relevant team members know, as soon as possible and by Discord, if they are running late to a scheduled shift, visit, or meeting.
...
For instance, the RA is expected to be available to run lab visits on evenings and weekends (see the section on [Scheduling Expectations](#sec-schedulingExpectations) below).
...
We expect RAs to regularly communicate with the team, using the appropriate methods of communication, as described in the [Lab Communication](lab-manual.qmd#sec-labCommunication) section of the Lab Manual.
