...
In addition to the ongoing [School Readiness Study](study-schoolReadinessStudy.html), we are also in the process of designing another study, the [Externalizing Assessment Project](https://devpsylab.github.io/ExternalizingAssessmentProject).
Externalizing problems change in behavioral manifestation across development.
In this project, we aim to develop a novel assessment system to assess the externalizing spectrum in comparable and developmentally sensitive ways across infancy to adolescence, so that we can identify children early on who are at risk of later, more severe problems.
