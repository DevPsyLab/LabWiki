...
If you are interested, you may pursue an Honors project and thesis, as long as you have a full year available (and the time necessary) to conduct the project and you meet the other expectations for Honors projects described [here](#sec-expectations-thesis).
...
## Honors Thesis {#sec-expectations-thesis}
...
# Working on Your Thesis {#sec-working}

The easiest way to work on your thesis is to work on it in the lab.
If you must work on your thesis outside of the lab, you may either 1) [VPN into the lab drive](documentation-remote.html#vpn) or 2) ["remote in" to a lab computer](documentation-remote.qmd#sec-remoteAccess).
