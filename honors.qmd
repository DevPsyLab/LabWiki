---
title: "Independent Projects and Honors Projects: Expectations and Resources"
---

# Overview of Honors Options {#sec-options}
...
# Non-Thesis Honors {#sec-expectations-nonThesis}
...
# Independent Projects {#sec-independentProjects}
...
If you are interested, you may pursue an <u>Honors project and thesis</u>, as long as you have a full year available (and the time necessary) to conduct the project and you meet the other expectations for Honors projects described [here](#sec-expectations-thesis).
However, you may also pursue an <u>independent poster project</u> without pursuing an Honors project/thesis.
Regardless of which path your pursue, you are encouraged to present your findings at the UI Undergraduate Research Festival or other [conferences](#sec-conferences).
...
## Honors Project/Thesis {#sec-expectations-thesis}
...
## Independent Research Projects {#sec-expectations-posterProject}

Students may also pursue an independent research project (including posters and presentations).
Unlike Honors Projects, the timeline for an independent research project is determined by the student.
Students may pursue independent research projects individually or in groups under the mentorship of graduate students, lab staff, or Dr. Petersen.
Work related to an independent research project is expected to take place outside of your regular 10 hours in the lab.
You will spend time conducting a literature review, formulating a research question, performing data analysis, interpreting your results, and designing your poster/presentation.


# Resources {#sec-resources}

For more information on the [School Readiness Study](study-schoolReadinessStudy.qmd), you are encouraged to read papers from the project, view the available measures, examine the Data Dictionary, and see the pre-registered hypotheses.
These resources are available on the project page for the [School Readiness Study](study-schoolReadinessStudy.qmd).

There are many helpful resources on the lab drive for thesis projects, including resources for data analysis, example theses, example posters, poster templates, cover page instructions, and helpful readings.
You can find these resources at the following locations on the lab drive:
...
We also have a page the clarifies the difference between mediation and moderation [here](mediationModeration.qmd).

For resources to help you learn statistics, see the ["Statistics" page](https://devpsylab.github.io/DataAnalysis/statistics.html) of the lab's Data Analysis Guides.
...
# Steps to Get Started {#sec-getstarted}

## Non-Thesis Honors {#sec-getstarted-nonThesis}

Before you meet with Dr. Petersen, send Dr. Petersen a draft of your pre-launch agreement form.

## Formulating a Research Question {#sec-researchQuestion}

When deciding what topic you want to research for an independent project, you should consider what you are curious about and then narrow down the scope of your topic.
Consider some of the following guiding questions:

- What **population** are you interested in learning about?
- Are you interested in **mechanisms** that explain development? (*mediation*)
- What are potential causes or effects of a behavior/environmental factor?
- Are you interested in associations over time (i.e. longitudinal questions)?
- What is already known on the topic, and what is missing from existing literature?
- Does an effect depend on another variable? (*moderation*)

You can explore your topic and formulate a more focused research question by [accessing research articles](#sec-articles) and conducting a literature review.

## Honors Thesis {#sec-getstarted-thesis}
...
## Independent Poster Projects {#sec-getStarted-posterProjects}

To get started on an independent poster/presentation project, (1) think about what you would like to study, (2) begin to read up on it, and (3) take preliminary notes on:

a) what you are interested in studying
b) why you are interested in studying it
c) what you have learned in doing reading on the topic
d) what specific research question(s) you have

Then, set up a meeting with graduate students or lab staff to discuss your idea and next steps.

# Accessing the Lab Drive {#sec-labdrive}
...
For instructions to set up VPN, see [here](documentation-remote.qmd#sec-vpn).

# Accessing Articles through the UI Libraries {#sec-articles}

You should be able to access many, if not most, articles using [Google Scholar](https://purl.lib.uiowa.edu/GoogleSch).
Other databases include [PsycInfo](https://purl.lib.uiowa.edu/apa/psycinfo), [Web of Science](http://purl.lib.uiowa.edu/wos), and [PubMed](https://purl.lib.uiowa.edu/nlm/pubmed).
...
## Reference Managers {sec-referenceManagers}

As a UIowa student, you have access to several reference managers that will help you organize and keep track of research articles.
You can learn more about reference managers available to you here: <https://guides.lib.uiowa.edu/citationmanagement>

# Working on Your Project {#sec-working}

The easiest way to work on your thesis or independent project is to work on it in the lab.
If you must work on your thesis or independent project outside of the lab, you may either 1) [VPN into the lab drive](documentation-remote.html#vpn) or 2) ["remote in" to a lab computer](documentation-remote.qmd#sec-remoteAccess).
For instructions how to do each, see the [RA Remote Participation page](documentation-remote.qmd).

# Statistical Analysis Software {#sec-software}
...
Unlike [`SPSS`](https://devpsylab.github.io/DataAnalysis/SPSS.html), however, [`jamovi`](https://devpsylab.github.io/DataAnalysis/jamovi.html) is free, so you will be able to use it freely after you leave the university.
...
# Access SPSS/R for Data Analysis {#sec-spss-R}
...
For instructions to set up VPN, see [here](documentation-remote.html#sec-vpn).
Follow the steps below to set up Virtual Desktop for the first time.

1. Connect to [VPN](documentation-remote.html#sec-vpn) using Cisco AnyConnect.
...
# Writing Guidelines {#sec-writing}

Make sure to follow the lab's [writing guidelines](writing.qmd).
You are also encouraged to take advantage of the [UI Writing Center](https://writingcenter.uiowa.edu).

# Poster Design

UIowa has many resources available that can help you design an effective research poster.
You can review the Design Center's poster guidelines here: <https://designcenter.uiowa.edu/creating-effective-posters>

You can also access poster templates in the lab drive here: `\\lc-rs-store24.hpc.uiowa.edu\lss_itpetersen\Lab\Publications\Posters\Templates`

# Presenting Work at Conferences {#sec-conferences}
...
- posting a [preprint](openScience.html#sec-preprint) on a preprint server
