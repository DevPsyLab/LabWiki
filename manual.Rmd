...
By Monday of the week the article will be discussed, the RA picking the article should post the article PDF and full APA-style reference in the `#lab-meetings` channel on Slack.
...
They are also responsible for emailing several detailed questions or comments on the article to the Lab Coordinator by the day before the meeting to help contribute to the discussion.
