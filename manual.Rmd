...
There may be an opportunity for some experiences to count for lab hours if:
   ...
   1. The RA has demonstrated proficiency at the experience

For example, our lab leverages [R](https://devpsylab.github.io/DataAnalysis/R.html) for a variety of tasks.
RA's may be able to use R to complete lab projects if they take the time outside of lab hours to tackle the steep learning curve.
Furthermore, RA's may have an opportunity to lear how EEG data is processed.
This is certainly not meant to discourage pursuing these experiences, but set expectations for how they will look.
