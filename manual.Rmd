...
Below are some guidelines on how to handle study data and participant information in various contexts.

**Talking About Participants Outside of Lab**

While it may be tempting to share lab-related information outside of lab, it is important that you are careful about what you share.
Even if you are talking to other RAs or people on our IRB project, you never know who else might be able to hear your conversation.
...
Even when using Slack to communicate with team members about visits or lab-related tasks, team members should always use TCIDs and waves to refer to specific participants/videos.

**Remote Access**

RAs should never access lab data without permission or direction from the lab coordinator, a graduate student, or the PI.
...
It is recommended to enroll in URES:3992 when you cannot take credit-bearing courses (e.g., if you are getting paid, if don't have the ability to maintain a regular schedule, etc.).
...
- Students receive a letter grade (see section 4.2) for PSY:4990 and HONR:3994.
- Students receive a Pass/Fail grade for PSY:3994.

There are several advantages to registering for course credit:
- Your participation in lab will be accounted for on your transcript
    - Not only is this helpful to have officially listed among your other university courses every semester, but (if you meet the hours and expectations) it can also help your GPA
...
In addition to enrolling on MyUI, you can find the Honors Research Practicum syllabus on the lab drive (to be read and signed by the RA and Dr. Petersen) here: `\Lab\Miscellaneous\Course Syllabi\`
...
- Your work within the lab will be accounted for on your transcript (letter graded)
- The 10 hours per week you spend in lab will be accounted for in your course schedule
...
The Developmental Psychopathology Lab utilizes a "generalist with specialization" approach—we have three specialized tracks or roles that RAs can train in after completing basic lab training.
**Every role is important**.
Placement in these roles is dependent upon each RA's (a) interests, (b) aptitude, and (c) fit, in addition to (d) the team's needs.
...
- Data entry
- video coding for behavioral tasks
...
works well with 3-7-year-old children and parents; positive and cheerful attitude; mature; able to quickly and easily soothe upset children; able to stay calm and composed in the face of pressure; able to follow a script with adherence yet flexibility to tailor it to the individual child (age, interests, intellectual capacity, etc.); able to take feedback non-defensively and learn from feedback; confidence to remain in control of a chaotic environment

**Responsibilities Could Include:**

E for LV1 visits; train new LV1 Es; assuring procedural adherence for LV1 (including coaching RA and Camera roles, collaborating with other Es to ensure consistent administration); editing/updating LV1 manual procedures and scripts as needed; keeping LV1 observation room stocked and prepped for visits; lighter focus on coding
...
The DevPsy lab is happy to offer exceptional RAs the opportunity to gain advanced research experience in the form of leadership roles within the lab and the potential for a written or presented piece of research.
...
- Has shown a personal interest in the research being done in lab/research in general
- Meaningful and engaging research and leadership opportunities can be very helpful in building a CV and research background, but it also can be a lot of work and responsibility.
...
During their first weeks, new RAs can feel very overwhelmed and lost, as they need to acquire many new skills in a short amount of time.
While new RAs typically have the essential skills and interests to succeed in the lab, they are unfamiliar with the work culture, the lab processes and "unspoken rules."
...
ou are expected to be in lab for 10 regularly scheduled hours per week, on average, during the semester (excluding university holidays, breaks, and finals week).
...
[**Insert note about Lab Coordinator's responsibility**]
...
1. Setting Up Computer: 
    ...
    d. Checks:
        ...
        ii. Check for camera angles
            ...
            1. To select camera: Click [**INSERT**] icon (upper RH corner of each **camera** screen)
...
1. Open the DVD compartment of the CPU of your computer by clicking the button on it. Insert the DVD.
...
See LV2 Procedures manual for information regarding [**INSERT**]
...
1. Rename the "Combined.mp4" file with `TCID_Wave_LV1` and move it to the TC's LV1 video folder on the drive (Z:\Studies\School Readiness Study\Videos\Lab Visit 1)
...
1. Open the first visit video for a given TC (File  Open  Find files on lab drive)
