...
# Working Together Toward Our Mission {#sec-mission}

Everyone is expected to follow our [mission statements](lab-manual.qmd#sec-missionStatement), including our [internal](lab-manual.qmd#sec-missionStatement-internal) and [external](lab-manual.qmd#sec-missionStatement-external) mission statement, in addition to our [diversity statement](lab-manual.qmd#sec-diversityStatement).

# Confidentiality {#sec-confidentiality}

Everyone is expected to treat data confidentially, as described in the [Confidentiality](lab-manual.qmd#sec-confidentiality) section of the Lab Manual.
...
Everyone is expected to communicate regularly with the team, using the appropriate methods of communication, as described in the [Lab Communication](lab-manual.qmd#sec-labCommunication) section of the Lab Manual.
...
Our work depends on building strong relationships with children, families, and one another.
Facial expression, nonverbal communication, and clear speech are essential to that process.
Wearing a mask can interfere with these elements and with rapport.
Thus, unless you are ill (in which case you should stay home!) or are recovering from an illness, you should not wear a mask on a routine basis in the lab or during lab/work-related activities.
...
# Lab Publications and Presentations {#sec-labPublications}
...
Everyone is expected to follow the lab's [AI policy](ai-policy.qmd).

# Dress Code {#sec-dressCode}
...
Pants should be presentable and appropriate for working in a professional environment and with families.
Jeans and denim capris are acceptable when in lab, as long as they are not ripped or frayed.
Joggers (loose, tapered pants) are permitted provided they are clean and reasonably fitted.
Joggers should not be excessively baggy or resembling sleepwear.
If you choose to wear joggers, your outfit ensemble should be casual professional (e.g., not wearing sweatshirt as well).
Sweatpants are not permitted, including pants made from fleece or traditional sweatshirt material, or pants primarily intended for sleeping or lounging.
Leggings (tight, form-fitting workout clothes) are permitted if they are worn as tights (i.e., under a skirt, dress, shorts, or long shirt that fully covers the bottom).
...
Sweatshirts are acceptable when paired with jeans or more professional pants (i.e., not when paired with joggers).
...
For guidance on shorts guidelines, see the [DevPsy Lab Summerwear Guide](#sec-summerwear) (below).
...
On these days, you should wear a nice pair of pants/dress/skirt and shirt; you should not wear jeans, joggers, or shorts.

<details><summary>Guidance on Joggers vs. Sweatpants & Leggings</summary>

![Dress Code: Joggers](images/dressCode_joggers.png)

</details>

## DevPsy Lab Summerwear Guide {#sec-summerwear}
...
# Consequences of Non-Compliance {#sec-noncompliance}
...
# Role-Specific Expectations {#sec-roles}

In addition, people are expected to follow their expectations for the role, including expectations for [undergraduate research assistants](expectations-undergradRA.qmd), [SROP students](expectations-SROP.qmd), [graduate students](expectations-gradStudent.qmd), [postdoctoral scholars](expectations-postdoc.qmd), the [Lab Coordinator](expectations-labCoordinator.qmd), and [lab staff](expectations-labStaff.qmd).
