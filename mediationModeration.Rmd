...
When one mechanism fully accounts for the effect of the predictor variable on the outcome variable, this is known as **full mediation**.
However, many times a single process does not account for the full effect of the predictor variable on the outcome variable; this is known as **partial mediation** and is depicted below:
