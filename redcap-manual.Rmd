...
### Date Completed, Time Completed and Survey Durations
...
1. "Survey Duration:" 
   * Add a "Calculated Field" field
   * In the "Calculation Equation", enter the following equation
      * [survey-duration:instrument_name:m]
   * Add the following Action Tags 
      * @HIDDEN-SURVEY 
      * @READONLY
1. "Survey Duration Completed:" 
   * Add a "Calculated Field" field
   * In the "Calculation Equation", enter the following equation
      * [survey-duration-completed:instrument_name:m]
   * Add the following Action Tags 
      * @HIDDEN-SURVEY 
      * @READONLY  
