...
These events will first need to be designated accross events (See section on  [designating events](#designateInstruments)).
...
a.	Validation: integer from 0-59
Specify 12-hour time in the question
   ...
   - Duration: (e.g., How long does the child nap each day?)
      - Below you will enter how long your child naps each day. Please specify in hours and minutes. 
      ...
      - Have two variables for every time question:
         - 	hours (text box), italicized. Validation: integer (minimum 0; maximum—case specific)
         - minutes (text box), italicized
...
- When a field that will be hidden by branching logic has a value, REDCap offers to delete the value: “ERASE CURRENT VALUE OF THE FIELD?”
   - http://cri.uchicago.edu/wp-content/uploads/2016/04/REDCap-Avoid-Common-Pitfalls.pdf
...
- For Likert scales:
   ...
   - In general, values start with number 1 (not 0—unless value actually reflects complete absence of something)
