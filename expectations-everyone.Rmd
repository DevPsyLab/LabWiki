...
`\\iowa.uiowa.edu\Shared\ResearchData\rdss_itpetersen\Lab\Publications\`
...
`\\iowa.uiowa.edu\Shared\ResearchData\rdss_itpetersen\Lab\Publications\Conference Abstracts\`
- Conference posters: please add the PDF of the poster to the following location:
`\\iowa.uiowa.edu\Shared\ResearchData\rdss_itpetersen\Lab\Publications\Posters\`
- Conference presentations: please add the PDF of the presentation to the following location:
`\\iowa.uiowa.edu\Shared\ResearchData\rdss_itpetersen\Lab\Publications\Presentations\`
- Journal articles: please add the PDF of the paper to the following location:
`\\iowa.uiowa.edu\Shared\ResearchData\rdss_itpetersen\Lab\Publications\Papers\`
...
The following are NOT allowed: short-shorts, low-cut shirts, visible undergarments (including bralettes and sports bras), or workout/gym clothes (e.g., sweatpants, yoga pants).
...
https://www.monster.com/career-advice/article/work-attire-whats-appropriate-and-whats-not-hot-jobs (archived at https://perma.cc/DF8K-4RLK)
